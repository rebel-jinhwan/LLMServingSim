...
#
# Each run writes to llmservingsim/profiler/perf/<HARDWARE>/<MODEL>/<variant>/tp{1,2}/ — see
...
echo
echo "All profiles done. Output under llmservingsim/profiler/perf/$HARDWARE/:"
for MODEL in "${MODELS[@]}"; do
    echo "  llmservingsim/profiler/perf/$HARDWARE/$MODEL/"
done
