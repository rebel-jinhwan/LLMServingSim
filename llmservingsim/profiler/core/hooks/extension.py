...
Registered via ``worker_extension_cls="llmservingsim.profiler.core.hooks.extension.Extension"``
...
from llmservingsim.profiler.core.hooks.batch import Shot, assemble_scheduler_output
from llmservingsim.profiler.core.hooks.moe_hook import (
    ExpertRoute,
    force_moe_routing,
    single_moe_layer,
)
