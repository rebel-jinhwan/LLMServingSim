...
python -m llmservingsim.serving --cluster-config 'configs/cluster/single_node_single_instance.json' \
...
# python -m llmservingsim.serving --cluster-config 'configs/cluster/single_node_multi_instance.json' \
#     --dtype bfloat16 --block-size 16 \
...
# python -m llmservingsim.serving --cluster-config 'configs/cluster/single_node_pd_instance.json' \
#     --dtype bfloat16 --block-size 16 \
#     --dataset 'workloads/example_trace.jsonl' --output 'outputs/example_pd_run.csv' \
#     --num-reqs 10

# CXL memory expansion
# python -m llmservingsim.serving --cluster-config 'configs/cluster/single_node_cxl_instance.json' \
#     --dtype bfloat16 --block-size 16 \
#     --dataset 'workloads/example_trace.jsonl' --output 'outputs/example_cxl_run.csv' \
#     --num-reqs 10

# PIM attention offloading
# python -m llmservingsim.serving --cluster-config 'configs/cluster/single_node_pim_instance.json' \
...
# python -m llmservingsim.serving --cluster-config 'configs/cluster/single_node_power_instance.json' \
#     --dtype bfloat16 --block-size 16 \
...
# python -m llmservingsim.serving --cluster-config 'configs/cluster/single_node_tp_pp_instance.json' \
#     --dtype bfloat16 --block-size 16 \
#     --dataset 'workloads/example_trace.jsonl' --output 'outputs/example_tp_pp_run.csv' \
#     --num-reqs 10

# MoE with expert parallelism (tp=2, ep=2)
# python -m llmservingsim.serving --cluster-config 'configs/cluster/single_node_moe_single_instance.json' \
#     --dtype bfloat16 --block-size 16 \
...
# python -m llmservingsim.serving --cluster-config 'configs/cluster/single_node_moe_dp_ep_instance.json' \
#     --dtype bfloat16 --block-size 16 \
